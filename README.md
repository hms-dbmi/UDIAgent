...
| ------------------- | ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OPEN_API_KEY        | `OPEN_API_KEY=your-key-goes-here`                      | Required. The multi-agent system currently makes calls to OpenAI.                                                                                                                                    |
| GPT_MODEL_NAME      | `GPT_MODEL_NAME=gpt-5.4`                              | Optional. OpenAI model for orchestration. Defaults to `gpt-5.4`.                                                                                                                                    |
