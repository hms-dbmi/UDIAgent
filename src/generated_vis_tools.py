...
TOOL_DEFS = [{'function': {'description': '[barchart] Counts entities grouped by a nominal field, displayed as a vertical bar '
 ...
 {'function': {'description': '[barchart] Counts entities grouped by a nominal field, displayed as a horizontal bar '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[barchart] Creates a vertical bar chart counting entities by a nominal field. Design: '
                              'Vertical orientation for small category counts (<=4). Count aggregation applied '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[barchart] Creates a horizontal bar chart counting entities by a nominal field. Design: '
 ...
 {'function': {'description': '[stacked_bar] Counts entities grouped by two nominal fields, displayed as a horizontal '
                              'stacked bar chart. Design: Horizontal stacked layout for higher category counts (>4). '
                              'Color encodes the sub-group; stacking shows part-to-whole within each bar. Allows up to '
 ...
 {'function': {'description': '[scatterplot] Plots two quantitative fields as a scatterplot to explore their '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[scatterplot] Creates a scatterplot of two quantitative fields. Design: Point marks on '
 ...
 {'function': {'description': '[table] Counts the total number of records in an entity and displays the result as a '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[table] Displays the raw data for an entity as a table for exploration. Design: No '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[table] Creates a table displaying the raw data for an entity. Design: No aggregation '
 ...
 {'function': {'description': '[table] Joins two related entities and displays the combined data as a table. Design: '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[table] Creates a table that joins and displays the combined data of two entities. '
 ...
 {'function': {'description': '[table] Lists all distinct values of a nominal field with their counts, displayed as a '
                              ...
                              'occurrences. In-cell bars provide visual frequency comparison. Limits to fields with '
 ...
 {'function': {'description': '[line] Shows the cumulative distribution function (CDF) of a quantitative field as a '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[line] Creates a CDF (cumulative distribution function) plot of a quantitative field. '
 ...
 {'function': {'description': '[grouped_line] Shows the cumulative distribution of a quantitative field for each '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[grouped_line] Creates a CDF plot with a separate line for each category of a nominal '
                              'field. Design: Per-group CDF computation with color encoding to distinguish groups. '
 ...
 {'function': {'description': '[heatmap] Displays the count of entities for each combination of two nominal fields as '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[heatmap] Creates a heatmap showing entity counts for each combination of two nominal '
                              'fields. Design: Rect marks with color encoding and text labels. Text color adapts to '
 ...
 {'function': {'description': '[heatmap] Displays the average of a quantitative field for each combination of two '
                              ...
                              'aggregated by average, and two nominal axes. Color encodes the aggregate value. '
 ...
 {'function': {'description': '[histogram] Shows the distribution of a quantitative field as a histogram with '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[histogram] Creates a histogram of a quantitative field with automatically computed '
                              'bins. Design: Uses binby for automatic bin computation. Rect marks show bin ranges and '
 ...
 {'function': {'description': '[grouped_dot] Compares the distribution of a quantitative field across categories using '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[table] Counts the number of records with a non-null value in a specified field, shown '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[table] Computes the percentage of records with a non-null value in a specified field, '
                              'shown with a percentage bar. Design: Same computation as non-null count but framed as a '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[table] Counts the number of records with a null value in a specified field, shown '
                              'alongside the total with a percentage bar. Design: Derives null count as total minus '
               ...
               'parameters': {'additionalProperties': False,
                              ...
                              'type': 'object'}},
  'type': 'function'},
 {'function': {'description': '[table] Computes the percentage of records with a null value in a specified field, '
                              'shown with a percentage bar. Design: Same computation as null count but framed as a '
